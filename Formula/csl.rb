...
class Csl < Formula
  ...
  if OS.mac? && Hardware::CPU.arm?
    ...
    sha256 "f01f9d75aa9fe1dd9cdbf1d5d9e1d8272791868889d44d3237fdc92b7e5669a2"
  elsif OS.mac? && Hardware::CPU.intel?
    url "https://github.com/benbenbang/consilium/releases/download/#{version}/csl-darwin-amd64",
        using: GitHubPrivateRepositoryReleaseDownloadStrategy
    sha256 "0756fb278d8b2f82fc83e00def2dcbed38e7df6c10b9cc3f0af845ff9b13f757"
  elsif OS.linux? && Hardware::CPU.arm?
    url "https://github.com/benbenbang/consilium/releases/download/#{version}/csl-linux-arm64",
        using: GitHubPrivateRepositoryReleaseDownloadStrategy
    sha256 "4835cc24c42811da0bd3aabf00c14c7afffc871600f1d2a7216998f425d6466d"
  elsif OS.linux? && Hardware::CPU.intel?
    url "https://github.com/benbenbang/consilium/releases/download/#{version}/csl-linux-amd64",
        using: GitHubPrivateRepositoryReleaseDownloadStrategy
    sha256 "7c8fde09ea90ba6d17cb5d9099b542f8a03510f689c241be85738c9f1f3c48fd"
  end
